...
const SCHEDULES = {
  monday: {
    ...
    periods: [
      ...
      { name: "Passing",          start: "09:35", end: "09:40", type: "" },
      { name: "2nd Period",       start: "09:40", end: "10:30", type: "class"   },
      { name: "Passing",          start: "10:30", end: "10:40", type: "" },
      { name: "3rd Period",       start: "10:40", end: "11:30", type: "class"   },
      { name: "Passing",          start: "11:30", end: "11:35", type: "" },
      { name: "4th Period + Ann", start: "11:35", end: "12:30", type: "class"     },
      { name: "Lunch",            start: "12:30", end: "13:05", type: "lunch"   },
      { name: "Passing",          start: "13:05", end: "13:10", type: "" },
      { name: "5th Period",       start: "13:10", end: "14:00", type: "class"   },
      { name: "Passing",          start: "14:00", end: "14:05", type: "" },
      { name: "6th Period",       start: "14:05", end: "14:55", type: "class"   },
      { name: "Passing",          start: "14:55", end: "15:00", type: "" },
  ...
  tuethu: {
    ...
    periods: [
      ...
      { name: "Period 3 + Ann",  start: "10:25", end: "12:00", type: "class"     },
      { name: "Lunch",           start: "12:00", end: "12:35", type: "lunch"   },
      { name: "Passing",         start: "12:35", end: "12:40", type: "" },
      { name: "Period 5",        start: "12:40", end: "14:10", type: "class"   },
      { name: "Passing",         start: "14:10", end: "14:15", type: "" },
  ...
  wedfri: {
    ...
    periods: [
      ...
      { name: "Passing",         start: "11:50", end: "12:00", type: "" },
      { name: "Period 4",        start: "12:00", end: "13:30", type: "class"   },
      { name: "Passing",         start: "13:30", end: "13:35", type: "" },
...
function tick() {
  ...
  if(lastKey!==ds.key){
    document.getElementById("dayTypeLabel").textContent=ds.label;
    buildList(ds);
